...
--
-- Gerado por: npm run sql  (0001_schema.sql + 0002_rls.sql + 0003_login_attempts.sql + 0004_modelo_financeiro.sql + 0005_reserva_do_historico.sql + 0006_premio_do_ranking.sql + 0007_preferencias_do_app.sql)
